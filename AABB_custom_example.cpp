...
int main()
{
    ...
    K::Point_3 q_a(0.0, 0.0, 0.0);
    K::Point_3 q_b(10.0, 10.0, 10.0);
    K::Point_3 q_c(0.0, 0.0, 10.0);

    K::Triangle_3 triangle_query(q_a, q_b, q_c);
    std::cout << "intersect with triangle: " << tree.do_intersect(tree) << std::endl;
    return EXIT_SUCCESS;
}
